...
class DataCleaner:
    ...
    def _clean_row(self, row: dict[str, Any], idx: int) -> Optional[dict[str, Any]]:
    ...
    def _clean_ein(self, value: Any) -> Optional[str]:
    ...
    def _clean_address(self, row: dict[str, Any]) -> Optional[dict[str, str]]:
    ...
    def _clean_amount(self, value: Any) -> Optional[Decimal]:
